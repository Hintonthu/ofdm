...
sns.set_style("white")
lin_space = [0.1, 0.01, 0.001, 0.0001]
BER =[]
figure()
BER.append(np.loadtxt("./result/OFDM_BER_trained_at_2dB SNR_L4_64_lmbd_0.1")[3])
BER.append(np.loadtxt("./result/OFDM_BER_trained_at_2dB SNR_L4_64_lmbd_0.05")[3])
#BER.append(np.loadtxt("./result/OFDM_BER_trained_at_2dB SNR_L4_64_lmbd_0.03")[3])
BER.append(np.loadtxt("./result/OFDM_BER_trained_at_2dB SNR_L4_64_lmbd_0.01")[3])
BER.append(np.loadtxt("./result/OFDM_BER_trained_at_2dB SNR_L4_64_lmbd_0.001")[3])
...
PAPR.append(np.mean(np.loadtxt("./result/PAPR_at_2dB SNR_L4_64_lmbd_0.1")) )
PAPR.append(np.mean(np.loadtxt("./result/PAPR_at_2dB SNR_L4_64_lmbd_0.05")) )
#PAPR.append(np.mean(np.loadtxt("./result/PAPR_at_2dB SNR_L4_64_lmbd_0.03")) )
PAPR.append(np.mean(np.loadtxt("./result/PAPR_at_2dB SNR_L4_64_lmbd_0.01")) )
PAPR.append(np.mean(np.loadtxt("./result/PAPR_at_2dB SNR_L4_64_lmbd_0.001")) )
...
grid(which='minor')
grid(which='major')
plt.savefig('final_lambda_plot.eps', format='eps', dpi=300)
show()
