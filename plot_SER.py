...
err1 = np.loadtxt("./OFDM_SER_trained_at_0dB SNR_L4_200000_16QAM")
err2 = np.loadtxt("./OFDM_SER_trained_at_2dB SNR_L4_200000_16QAM")
err3 = np.loadtxt("./OFDM_SER_trained_at_4dB SNR_L4_200000_16QAM")
err4 = np.loadtxt("./OFDM_SER_trained_at_6dB SNR_L4_200000_16QAM")
err5 = np.loadtxt("./OFDM_SER_trained_at_8dB SNR_L4_200000_16QAM")
err6 = np.loadtxt("./OFDM_SER_trained_at_10dB SNR_L4_200000_16QAM")
err7 = np.loadtxt("./OFDM_SER_trained_at_12dB SNR_L4_200000_16QAM")

semilogy(lin_space, err1 ,color='r',  marker="o", markersize=5,linewidth=2, label="SER_trained_at_0dB SNR")
semilogy(lin_space, err2 ,color='g',  marker="o", markersize=5,linewidth=2,label="SER_trained_at_2dB SNR")
semilogy(lin_space, err3 ,color='b',  marker="o", markersize=5,linewidth=2,label="SER_trained_at_4dB SNR")
semilogy(lin_space, err4 ,color='purple',  marker="o", markersize=5,linewidth=2,label="SER_trained_at_6dB SNR")
semilogy(lin_space, err5 ,color='r',  marker="*", markersize=5,linewidth=2, label="SER_trained_at_8dB SNR")
semilogy(lin_space, err6 ,color='g',  marker="*", markersize=5,linewidth=2,label="SER_trained_at_10dB SNR")
semilogy(lin_space, err7 ,color='b',  marker="*", markersize=5,linewidth=2,label="SER_trained_at_12dB SNR")
